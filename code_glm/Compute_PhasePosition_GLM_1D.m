...
load([raw_dir '/Animal' num2str(animal) '/' add_cyph num2str(session) 'C_Raw_CSD'])
%load(['~/Data/Matteo_All/Animal' num2str(animal) '/'  num2str(session) 'C_Envelope'])
load([raw_dir '/Animal' num2str(animal) '/' add_cyph num2str(session) 'XY'])
load([raw_dir '/Animal' num2str(animal) '/' add_cyph num2str(session) 'Spikes'])
load([raw_dir '/Animal' num2str(animal) '/' add_cyph num2str(session) 'Running'])
Pos = XY;
...
PlotVal_Ch=cat(4,PlotVal_Ch,PlotVal);
    ...
    save([save_dir 'GLMPyrGamma_A' num2str(animal) '_S' num2str(session) '_G' num2str(comp) '_T' num2str(th_site) '_D' num2str(run_dir)  '_Sp' num2str(spike_type)],'PlotVal_Ch')
